...
function Features() {
  const assets: FeatureItemType[] = [
    {
      image: "/images/magic_chat.svg", title: "Magic Chat - ChatGPT for your podcast(s)", subTitle: "With Magic Chat, use contextual search and QnA to use Podnotes as an assistant to glance through all your podcasts at once.",
      details: [
    ...
    {
      image: "/images/audiogram.svg", title: "Audiograms", subTitle: "Create snippets of your podcast into easily shareable and visually appealing asset to share on your social media",
      details: [
  ...
  return (
    <div className='max-w-[1120px] my-[80px]'>
      <Headline
        ...
        headline='Your perfect Podcast Assistant'
