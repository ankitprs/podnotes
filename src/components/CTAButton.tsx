...
function CTAButton({ linkUrl = "", className = "bg-white text-black", classNameForIcon = "", iconColor = undefined }: { linkUrl?: string, className?: string, classNameForIcon?: string, iconColor?: string }) {
